(function () {
	...
	var propTabs = {
		...
		primer_encabezado: document.getElementById('encabezado_forma').firstElementChild,
		primer_contenido: document.getElementById('contenido_forma').firstElementChild,
		enlaces_encabezado: document.querySelectorAll('#encabezado_forma li a'),
		li_encabezado: document.querySelectorAll('#encabezado_forma li'),
		divs_contenido: document.querySelectorAll('#contenido_forma > div'),
